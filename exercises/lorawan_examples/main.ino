 ...
 *******************************************************************************/
 ...
 /// NOTE FROM TA: THIS IS A REDISTRIBUTION OF THE LICENSE DESCRIBED ABOVE AND PARTS OF THE REPO https://github.com/kizniche/ttgo-tbeam-sensor-node-bme280
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
      ...
      byte co2High = highByte(payloadPress);
